...
public class SimpleGreetResource {
    ...
    private static final Logger LOGGER = Logger.getLogger(SimpleGreetResource.class.getName());
    ...
    public Message getDefaultMessage() {
        LOGGER.info("Executing GET /simple-greet");
    ...
    public String getMessage(@PathParam("name") String name) {
        LOGGER.info("Executing GET /simple-greet/{name}");
